...
class Modbus : public uart::UARTDevice, public Component {
 public:
  ...
  void set_flow_control_pin_pre_send_delay(uint16_t time_in_ms) { this->flow_control_pin_pre_send_delay_ms_ = time_in_ms; }
  ...
  void set_rx_buffer_delay(uint16_t time_in_ms) { this->rx_buffer_delay_override_ms_ = time_in_ms; }
 ...
 protected:
  ...
  uint16_t rx_buffer_delay_override_ms_{0};
  ...
  uint32_t impossible_leading_byte_drop_count_{0};
